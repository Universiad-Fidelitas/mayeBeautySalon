...
export const PagosImageUploader = ({ initialImages, setImageState }) => {
  ...
  return (
    <>
      <ImageUploading multiple value={initialImages} onChange={onChange} maxNumber={1} dataURLKey="dataurl">
