!(function (C, t) {
  ...
  return (() => {
    var C = {
        269: (C, t, a) => {
          'use strict';
          a.r(t), a.d(t, { icons: () => c, replace: () => s });
          var p = a(991),
            h = a.n(p);
          const M = JSON.parse(
            '{"xmlns":"http://www.w3.org/2000/svg","width":20,"height":20,"viewBox":"0 0 20 20","fill":"none","stroke":"currentColor","stroke-width":1.5,"stroke-linecap":"round","stroke-linejoin":"round"}'
          );
          function L(C, t) {
            var a = Object.keys(C);
            ...
            for (var t = 1; t < arguments.length; t++) {
              ...
              t % 2
                ...
                : L(Object(a)).forEach(function (t) {
                    Object.defineProperty(C, t, Object.getOwnPropertyDescriptor(a, t));
                  });
            }
            return C;
          }
          function e(C, t, a) {
            return t in C ? Object.defineProperty(C, t, { value: a, enumerable: !0, configurable: !0, writable: !0 }) : (C[t] = a), C;
          }
          const V = class {
              constructor(C, t) {
                (this.name = C), (this.contents = t), (this.attrs = d(d({}, M), { class: 'cs-icon cs-icon-'.concat(C) }));
              }
              toSvg() {
                let C = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                const t = d(d(d({}, this.attrs), C), { class: h()(this.attrs.class, C.class) });
                return '<svg '
                  .concat(
                    (function (C) {
                      return Object.keys(C)
                        .map((t) => ''.concat(t, '="').concat(C[t], '"'))
                        .join(' ');
                    })(t),
                    '>'
                  )
          ...
          function l(C) {
            ...
            const a = n(C),
              p = a.icon;
            if ((delete a.icon, c[p])) {
              const M = c[p].toSvg(i(i(i({}, t), a), { class: h()(t.class, a.class) })),
                L = new DOMParser().parseFromString(M, 'image/svg+xml').querySelector('svg');
              C.parentNode.replaceChild(L, C);
            } else console.warn('[csicons] '.concat(p, ' icon is not defined.'));
          }
          function n(C) {
            return Array.from(C.attributes).reduce((C, t) => {
              const a = t.name.replace('data-cs-', '');
              return 'size' === a ? ((C.width = t.value), (C.height = t.value)) : (C[a] = t.value), C;
            }, {});
          }
          const s = function () {
            let C = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
            if ('undefined' == typeof document) throw new Error('`csicons.replace()` only works in a browser environment.');
            const t = document.querySelectorAll('[data-cs-icon]');
            Array.from(t).forEach((t) => l(t, C));
          };
        },
        991: (C, t) => {
          var a;
          !(function () {
            ...
            var p = (function () {
              function C() {}
              function t(C, t) {
                for (var a = t.length, p = 0; p < a; ++p) h(C, t[p]);
              }
              ...
              function h(C, h) {
                if (h) {
                  ...
                  'string' === M
                    ? (function (C, t) {
                        for (var a = t.split(p), h = a.length, M = 0; M < h; ++M) C[a[M]] = !0;
                      })(C, h)
                    : Array.isArray(h)
                    ? t(C, h)
                    : 'object' === M
                    ? (function (C, t) {
                        if (t.toString === Object.prototype.toString) for (var p in t) a.call(t, p) && (C[p] = !!t[p]);
                        else C[t.toString()] = !0;
                      })(C, h)
                    : 'number' === M &&
                      (function (C, t) {
              ...
              return function () {
                for (var a = arguments.length, p = Array(a), h = 0; h < a; h++) p[h] = arguments[h];
                var M = new C();
                t(M, p);
                var L = [];
                for (var d in M) M[d] && L.push(d);
                return L.join(' ');
              };
            })();
            C.exports
    ...
    function a(p) {
      ...
      var M = (t[p] = { exports: {} });
      return C[p](M, M.exports, a), M.exports;
    }
    return (
      (a.n = (C) => {
      ...
      (a.d = (C, t) => {
        for (var p in t) a.o(t, p) && !a.o(C, p) && Object.defineProperty(C, p, { enumerable: !0, get: t[p] });
      }),
      (a.o = (C, t) => Object.prototype.hasOwnProperty.call(C, t)),
      (a.r = (C) => {
