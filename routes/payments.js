...
router.post('/add', upload.single('voucher_path'), uploadMiddleware, postPayments)

router.get('/:payment_id', [ param('payment_id').isNumeric().withMessage('payment_id must be a number')], getById)
router.put('/:payment_id', [ param('payment_id').isNumeric().withMessage('payment_id must be a number')], router.put('/:payment_id', [ param('payment_id').isNumeric().withMessage('payment_id must be a number')], upload.single('voucher_path'), uploadMiddleware, putPayments))
